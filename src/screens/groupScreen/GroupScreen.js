...
const iconSize = width > 600 ? 22 : width > 400 ? 12 : 10;
const iconSized = width > 600 ? 22 : width > 400 ? 24 : 20;
const circleSize = width > 600 ? 22 : width > 400 ? 28 : 24;
const paddingSize = width > 600 ? 22 : width > 400 ? 6 : 2;
const marginLeftd = width > 600 ? 22 : width > 400 ? -15 : -10;
const imageLeftd = width > 600 ? 22 : width > 400 ? -30 : -50;
            ...
            <TouchableOpacity onPress={() => navigation.navigate('GroupExpanseScreen', { ...item })} style={{ backgroundColor: '#f2f3f5', borderRadius: 10, margin: 10, marginTop: 15, padding: 15, flex:1 }}>
              <View style={{ flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center' }}>
                <View style={{ flexDirection: 'row', justifyContent: 'center', alignItems: 'center', width:'30%' }}>
                  <View style={{ marginTop: -80, marginLeft: 2 }}>
                    ...
                    <TouchableOpacity
                      ...
                      style={{ padding: 6, backgroundColor: '#d6d0d0', borderRadius: 50, marginLeft: marginLeftd, marginTop:-20 }}
                    >
                      <MaterialIcons name="delete-outline" size={iconSized} color="red" />
                    </TouchableOpacity>

                  </View>
                  <Image source={randemImage()} style={{ width: 40, height: 40, borderRadius: 10, marginLeft: imageLeftd }} />
                  <View>
                    <Text style={{ fontWeight: '800', marginLeft: 10, width: '80%' }}>{item.title}</Text>
                    <Text style={{ fontWeight: '600', color: 'green', fontSize: 10, marginLeft: 10 }}>Group Spend</Text>
                    <Text style={{ fontWeight: '600', color: "#db4649", marginLeft: 10 }}>₹ {tripTotals[item.id]?.toFixed(2) || 0}</Text>
                  </View>
                </View>

                <View style={{ flexDirection: 'row', alignItems: 'center', marginRight: 5 ,width:'65%'}}>
                  ...
                  <View style={{ marginLeft: 5, width:'40%' }}>
                    ...
                    <TouchableOpacity
                      ...
                      style={{ padding: paddingSize, backgroundColor: 'gray', borderRadius: 50, flexDirection: 'row' }}
                    >
                    ...
                    >
                      <Text style={{ fontSize: iconSize, marginLeft: 8, marginTop: 3 }}>Add Member</Text>
                    </TouchableOpacity>

                  </View>

                  <View style={{ marginLeft: 15, marginRight: -20,  width:'60%'  }}>
                    <TouchableOpacity
                      onPress={() => navigation.navigate('GroupExpanseScreen', { ...item })}
                      style={{ backgroundColor: '#c4c0c0', padding: 7, borderRadius: 10, paddingLeft: 8, paddingRight: 8, margin: 5, borderColor:'green', borderWidth:2 }}
                    >
                      <Text style={{ fontSize: iconSize }}>Add Expences +</Text>
                    </TouchableOpacity>
                    <TouchableOpacity
                      onPress={async () => {
                        setSelectedGroupId(item.id);
                      ...
                      style={{ backgroundColor: '#c4c0c0', padding: 7, borderRadius: 10, paddingLeft: 8, paddingRight: 8, margin: 5, borderColor:'gold', borderWidth:2 }}

                    >
                      <Text style={{ fontSize: iconSize }}>{memberCounts[item.id] || 0} Member Details </Text>
                    </TouchableOpacity>
                  </View>
                </View>
              </View>
